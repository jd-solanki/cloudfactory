/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fc07c3d58947d0336c55a4b53eef632b)
// Runtime types generated with workerd@1.20260831.1 2026-09-04
interface __BaseEnv_Env {
  GITHUB_TOKEN: SecretsStoreSecret;
  MODEL_API_KEY: SecretsStoreSecret;
  MODEL_BASE_URL: "https://aisubs-gw.jdsolanki0001.workers.dev/aisubs/chatgpt/default/v1";
  MODEL_NAME: "gpt-5.6-luna";
  MODEL_REASONING_EFFORT: "low";
  SANDBOX: DurableObjectNamespace<import("./src/index").Sandbox>;
  REVIEW_WORKFLOW: Workflow<Parameters<import("./src/index").ReviewWorkflow["run"]>[0]["payload"]>;
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "MODEL_BASE_URL" | "MODEL_NAME" | "MODEL_REASONING_EFFORT">
  > {}
}
